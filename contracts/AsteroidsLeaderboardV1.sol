...
contract AsteroidsLeaderboardV1 {
    ...
    function getLeaderboard()
        ...
        view
        returns (
            address[LEADERBOARD_LENGTH] memory,
            uint256[LEADERBOARD_LENGTH] memory,
            uint256[LEADERBOARD_LENGTH] memory
        )
    {
    ...
    function setHighscore(uint256 _score)
        public
        returns (
            address[LEADERBOARD_LENGTH] memory,
            uint256[LEADERBOARD_LENGTH] memory,
